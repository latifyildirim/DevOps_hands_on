...
locals {
  github-email    = "lyildirim.3017@gmail.com"     # you need to change this line
  github-username = "latifyildirim"                # you need to change this line
  github-token    = "xxxxxxxxx"                # you need to change this line
  key_pair        = "latif"                   # you need to change this line
  pem_key_address = "~/.ssh/latif.pem"        # you need to change this line
